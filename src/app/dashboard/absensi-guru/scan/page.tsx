  ...
  return <div className="max-w-3xl mx-auto pb-20 md:pb-6 px-3 sm:px-4 md:px-6" data-unique-id="e7d7d9cf-285f-4e30-b642-41618ec495eb" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true">
      ...
      duration: 0.3
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4" data-unique-id="3a31698a-0e73-4cfe-b5cd-5461c54a24af" data-file-name="app/dashboard/absensi-guru/scan/page.tsx">
            ...
            <Link href="/dashboard/absensi-guru/attendance-table" className="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center" data-unique-id="e44ce7c5-e2b2-4cda-bb93-d75bb8ae21ba" data-file-name="app/dashboard/absensi-guru/scan/page.tsx">
          ...
          <div className="p-6 border-b border-gray-200" data-unique-id="5126f0f3-e6a1-4da6-9129-954e72682513" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true">
            ...
            {/* Recognized teacher */}
            {recognizedTeacher && <div className="p-4 bg-blue-50 rounded-lg mb-4 border border-blue-200" data-unique-id="079b614b-8eea-4002-8e0c-117536b80737" data-file-name="app/dashboard/absensi-guru/scan/page.tsx">
                ...
                <p className="text-sm text-blue-600" data-unique-id="2011a9ff-236b-44ea-831d-c27ef674a9d9" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true"><span className="editable-text" data-unique-id="d63d5544-1a6b-41ba-9257-e9457b13f38b" data-file-name="app/dashboard/absensi-guru/scan/page.tsx">NIK: </span>{recognizedTeacher.nik}</p>
                <p className="text-sm text-blue-600" data-unique-id="f5a19de5-8351-4ece-8e86-1946ae997569" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true"><span className="editable-text" data-unique-id="85e40a5d-3d0d-4e2e-b575-70051340847b" data-file-name="app/dashboard/absensi-guru/scan/page.tsx">Jabatan: </span>{recognizedTeacher.role}</p>
              </div>}
          </div>
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4" data-unique-id="584cd3d7-b43f-4246-8616-cbf497b37fac" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true">
            ...
            {processingCapture && <div className="col-span-full flex items-center justify-center py-3 bg-gray-300 text-gray-700 rounded-lg font-medium" data-unique-id="a984ae1f-e953-4533-84a7-44908a59759c" data-file-name="app/dashboard/absensi-guru/scan/page.tsx">
