  ...
  return <div className="max-w-3xl mx-auto pb-20 md:pb-6 px-3 sm:px-4 md:px-6" data-unique-id="e7d7d9cf-285f-4e30-b642-41618ec495eb" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true">
      ...
      duration: 0.3
          ...
          <div className="p-6 border-b border-gray-200" data-unique-id="5126f0f3-e6a1-4da6-9129-954e72682513" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true">
            ...
            {/* Recognized teacher */}
            {recognizedTeacher && 
              <center><div className="p-4 bg-purple-50 rounded-lg mb-4 border border-purple-200" data-unique-id="079b614b-8eea-4002-8e0c-117536b80737" data-file-name="app/dashboard/absensi-guru/scan/page.tsx">
                <h3 className="text-lg font-semibold text-purple-800" data-unique-id="3685f6bc-8cbe-49d8-8954-1e7df183a1a1" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true">{recognizedTeacher.name}</h3>
                <p className="text-sm text-purple-600" data-unique-id="2011a9ff-236b-44ea-831d-c27ef674a9d9" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true">
                ...
                <p className="text-sm text-purple-600" data-unique-id="f5a19de5-8351-4ece-8e86-1946ae997569" data-file-name="app/dashboard/absensi-guru/scan/page.tsx" data-dynamic-text="true">
