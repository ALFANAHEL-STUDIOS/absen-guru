...
const startCamera = async () => {
  try {
    setScanning(true);
    // Show teacher data immediately when camera is activated
...
const sendTelegramNotification = async (teacherName: string, attendanceType: string, date: string, time: string) => {
  try {
    ...
    const message = `GTK dengan nama : ${teacherName} telah melakukan "Absen : ${messageType}" di Sekolah pada tanggal ${date} pukul ${time}.`;
    // Send notification
...
return <div className="max-w-3xl mx-auto pb-20 md:pb-6 px-3 sm:px-4 md:px-6">
    ...
    duration: 0.3
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          {/* Recognized teacher - now shown as soon as camera is activated */}
          {showTeacherData && recognizedTeacher && (
