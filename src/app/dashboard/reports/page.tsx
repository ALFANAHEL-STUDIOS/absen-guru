    ...
    <div className="pb-20 md:pb-6">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 md:gap-4">
          ...
          <Link href="https://absensi-digital-modern.vercel.app/dashboard/reports/monthly-attendance/" className="bg-red-50 rounded-xl shadow-sm p-5 hover:shadow-md transition-all border border-red-200 text-gray-800">
