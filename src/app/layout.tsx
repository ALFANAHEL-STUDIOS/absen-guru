...
export default function RootLayout({
  ...
  return <html lang="id" className={`${GeistSans.variable} scroll-smooth`} data-unique-id="fe829ec2-a1a8-4153-b52c-194e57f0f563" data-file-name="app/layout.tsx">
      <body className="antialiased" data-unique-id="75f9e379-953f-4568-992d-c07d29f74a6f" data-file-name="app/layout.tsx">
        <AuthProvider>
